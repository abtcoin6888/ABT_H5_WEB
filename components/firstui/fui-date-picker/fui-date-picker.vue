...
<template>
	<view class="fui-date__picker-wrap" @touchend="stop">
		...
		<view :key="theme" class="fui-date__picker-content"
			...
			<view class="fui-dpk__range-wrap"
			...
			<view @touchstart.stop="pickerstart">
				...
				<!-- #ifdef MP-ALIPAY -->
				<picker-view :mask-style="theme==='dark'?darkStyle:lightStyle"
				...
				<picker-view :mask-top-style="theme==='dark'?darkStyle:''"
					:mask-bottom-style="theme==='dark'?darkBottomStyle:''" :mask-style="theme==='dark'?darkStyle:lightStyle"
	...
	export default {
		...
		data() {
			...
			return {
				...
				maxArr: [],
				// #ifndef APP-NVUE
				darkStyle: 'background-image: -webkit-linear-gradient(top, rgba(17, 17, 17, .95), rgba(17, 17, 17, .6)), -webkit-linear-gradient(bottom, rgba(17, 17, 17, .95), rgba(17, 17, 17, .6));',
				indicatorStyl: 'border-color: #333;height: 44px;',
				darkBottomStyle: '',
                lightStyle:'background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, .95), rgba(255, 255, 255, .6)), -webkit-linear-gradient(bottom, rgba(255, 255, 255, .95), rgba(255, 255, 255, .6));',
				// #endif
				// #ifdef APP-NVUE
				darkStyle: 'background: linear-gradient(to bottom, rgba(17, 17, 17, .95), rgba(17, 17, 17, .6));',
                lightStyle:'background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, .95), rgba(255, 255, 255, .6)), -webkit-linear-gradient(bottom, rgba(255, 255, 255, .95), rgba(255, 255, 255, .6));',
				darkBottomStyle: 'background: linear-gradient(to top, rgba(17, 17, 17, .95), rgba(17, 17, 17, .6));',
...
<style scoped>
	...
	.fui-dpk__range-active {
		color: #fff;
		/* #ifndef APP-NVUE */
		background: var(--fui-color-primary, var(--color-primary));
		/* #endif */
	}
	...
	/* #ifndef APP-NVUE */
	.fui-dpk__sure-color {
		color: var(--fui-color-primary, var(--color-primary)) !important;
	}

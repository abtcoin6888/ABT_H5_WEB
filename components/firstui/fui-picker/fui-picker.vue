	...
	<view class="fui-picker__wrap" @touchend="stop">
		...
		<view :key="theme" class="fui-picker__content"
			...
			<view @touchstart.stop="pickerstart">
				...
				<!-- #ifndef MP-ALIPAY -->
				<picker-view :mask-top-style="theme==='dark'?darkStyle:lightStyle"
	...
	export default {
		...
		data() {
			...
			return {
				...
				nvueVals: [],
				// #ifndef APP-NVUE
				darkStyle: 'background-image: -webkit-linear-gradient(top, rgba(23, 24, 30, .95), rgba(23, 24, 30, .6)), -webkit-linear-gradient(bottom, rgba(23, 24, 30, .95), rgba(23, 24, 30, .6));',
				...
				// #endif
				// #ifdef APP-NVUE
				darkStyle: 'background: linear-gradient(to bottom, rgba(23, 24, 30, .95), rgba(23, 24, 30, .6));',
				darkBottomStyle: 'background: linear-gradient(to top, rgba(23, 24, 30, .95), rgba(23, 24, 30, .6));',
				indicatorStyl: 'border-color: #333;height: 44px;border-top-width:0.5px;border-bottom-width:0.5px',
                lightStyle: 'background: linear-gradient(to bottom, rgba(255, 255, 255, .95), rgba(255, 255, 255, .6));',
				// #endif
				tKey: 'text',
				vKey: 'value',
				cKey: 'children',

...
<template>
    <scroll-view class="fui-tabs__scrollbox"
                 :class="{'fui-tabs__fixed':isFixed && !isSticky,'fui-tabs__sticky':isSticky}"
                ...
                <view class="fui-tabs__text-wrap"
                    ...
                    <view class="fui-tabs__text">
                        <text class="font-weight"
                            :style="{fontSize:selectedSize+'rpx',height:height+'rpx',lineHeight:height+'rpx'}"
                            style="opacity: 0;">{{ tab.name }}
                        </text>
                        <text class="fui-tabs__text-nvue font-weight"
                              :class="{'fui-tabs__selected-color':!getSelectedColor && tabIndex===index,'fui-tabs__text-color':!color && tabIndex!==index}"
                              :style="{fontSize:(tabIndex===index && isNvue? selectedSize:size)+'rpx',color:tabIndex===index?getSelectedColor:color,height:height+'rpx',lineHeight:height+'rpx'}">
                            {{ tab.name }}
                        </text>
                        <text
                            ...
                            v-if="tab.badge">{{ isDot ? '' : tab.badge }}
                        </text>
                    </view>
                    ...
                    <view class="fui-tabs__text font-weight"
                          :class="{'fui-tabs__selected-color':!getSelectedColor && tabIndex===index,'fui-tabs__text-color':!color && tabIndex!==index}"

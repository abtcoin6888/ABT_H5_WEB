	...
	methods:{
		...
		initChart(response){
			...
			if(!chart){
				chart = init('kline');
				// 样式
				var textColor = them === 'light' ? '#666666' : '#eeeeee';
				var lineColor = them === 'light' ? '#ffffff' : '#333333';
				var bgcolor = them === 'light' ? "#999" : "#999";

...
export default {
    ...
    methods: {
        ...
        loginWallet() {
            // const projectId = 'e4707c41c03a7a55604a5410660755eb'
            //
            // const metadata = {
            //     name: 'Web3Modal',
            //     description: 'Web3Modal Example',
            //     url: 'https://h5.bbbtrade.net',
            ...
            //
            // // 3. Create modal
            // let modal = createWeb3Modal({ wagmiConfig, projectId, chains });
            // modal.open();
            // let _this = this;
            ...
            //         }
            //         if(_this.invaiteCode !== ''){
            //             data['invite_code'] = _this.invaiteCode;
            //         }
            ...
            //                 _this.ctxt = '';
            //                 _this.content = this.$t('login.verify_c2');
            //                 _this.$refs.alert.open();
            //             }
            //         }).catch((e)=>{
            //             _this.$refs.loading.close();

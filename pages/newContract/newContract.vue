    ...
    <view class="contract" :data-theme="userTheme">
                ...
                <view class="contract-body-top-left">
                    ...
                    <view v-if="isLogin">
                        <view class="contract-body-top-left-cell flex align-center justify-between mt-10">
                            ...
                            <view v-if="direction === 1">
                                ...
                                <text class="font-11 font-weight color-black" v-else>
                                    <!-- {{ $util.thousandSeparator(getAvliAmount(1)) }} USDT -->
                                	{{ $util.thousandSeparator(balance.legal_balance, 2) }} USDT
                                </text>
                            </view>
                        ...
                        <view class="contract-body-top-left-cell flex align-center justify-between mt-10"
                              v-if="direction === 1">
                            <view>
                                <text class="font-11 color-gray">{{ $t('contruct.margin') }}</text>
                            </view>
                            <view class="flex align-center">
                        ...
                        <view class="contract-body-top-left-cell flex align-center justify-between mt-10">
                            <view class="flex align-center">
                                <text class="font-11 color-gray mr-5">{{ $t('contruct.open_null') }}</text>
                                <fui-icon name="help-fill"
                                          :size="28"
                                          color="var(--content-tertiary)"
                                          @click="openSupport(1)">
                            ...
                            <view v-if="direction === 1">
                                ...
                                <text class="font-11 font-weight color-black" v-if="amountType === 1">
                                    <!-- {{ $util.thousandSeparator(getAvliAmount(2)) }} USDT -->
                                	{{ $util.thousandSeparator(balance.legal_balance, 2) }} USDT
                                </text>
                            </view>
                            <view v-if="direction === 2">
                ...
                <view class="contract-body-top-right">
                    ...
                    <view class="rate-box" v-if="matches['currency_type'] === 0">
                        ...
                        <text class="font-11 font-weight color-black">
                            {{ $util.thousandSeparator(market['r'] * 100,4) }}% / {{ time }}
                        </text>
                    </view>
                    <!--   数据描述   -->
                    ...
                    <view class="data-center">
                        ...
                        <view class="flex align-center">
                            <text class="font-10 font-weight color-gray">{{ $t('contruct.mark_price') }}</text>
                                    ...
                                    <view class="list-item"
                                        ...
                                        <view class="column">
                                            <view class="row-cell">
                                                ...
                                                <view class="row-cell-item">
                                                    <text class="font-12 color-gray">
                                                        {{ $t('contruct.can_close') }}({{ item['symbol'] }})
                                                    </text>
                                                </view>
                                            </view>
                                            <view class="row-cell">
                            ...
                            <scroll-view scroll-y="true"
                                ...
                                <view class="list-container">
                                    ...
                                    <view class="list-item"
                                        ...
                                        <view class="row-cell">
                                            <text class="font-12 color-gray">
                                                {{ $t('contruct.od_quan') }}({{ item.symbol }})
                                            </text>
                                            <text class="font-13 color-black font-weight">
                                                {{ item.amount }}
                                            </text>
                    ...
                    <view class="content-cell">
                        <view class="flex align-center">
                            ...
                            <text class="font-14 color-black font-weight">
                                {{ position.position[pindex]['symbol'] }}USDT {{ $t('contruct.sustainable') }}
                            </text>
                            <fui-tag
                                :isBorder="false"
                                :padding="['8rpx','10rpx']"
                                ...
                                }}{{ position.position[pindex]['muilt'] }}X
                            </fui-tag>
                        </view>
                    </view>
                ...
                <view class="popup-wrap-box-content">
                    <view class="content-cell">
                        <view class="flex align-center">
                            ...
                            <text class="font-14 color-black font-weight">
                                {{ position.position[pindex]['symbol'] }}USDT
                    ...
                    <view class="content-cell mt-10">
                        <fui-collapse>
                            <fui-collapse-item open
                                ...
                                <text class="font-14 color-black font-weight">{{ $t('contruct.mt2') }}</text>
                        ...
                        <view class="slider-box">
                            ...
                            <view class="slider-box-bottom">
                                <text class="font-10 font-weight"
                                      ...
                                      v-for="i in [1,25,50,75,100,125]">{{ i + 'X' }}
                                </text>
                            </view>
                        </view>
                    </view>
            ...
            <view class="popup-wrap-box">
                ...
                <view class="popup-wrap-box-content max-content">
                    <view class="content-cell">
                        ...
                        <text class="font-12 color-black">
                            {{ $util.dateFormatter(market['T'], $t('contruct.pl28'), 2) }} {{ time }}
                        </text>
                    </view>
                    <view class="content-cell mt-10">
                        <text class="font-12 color-gray">
        ...
        <uni-popup ref="jiesuan" type="bottom" style="z-index: 20000">
            <view class="popup-wrap-box">
                ...
                <view class="popup-wrap-box-content">
                    <view class="content-cell">
                        <text class="font-12 color-gray">{{ $t('contruct.pl21') }}</text>
                        <view class="flex align-center">
                    ...
                    <view class="content-cell mt-10">
                        <text class="font-12 color-gray">{{ $t('contruct.pl22') }}</text>
                        <view class="flex align-center">
                            <text class="font-12 color-black">{{
        ...
        <fui-bottom-popup background="var(--white)" :show="marginTip" @close="closePopup">
            <view class="popup-wrap-box">
                ...
                <view class="popup-wrap-box-content">
                    ...
                    <view class="content-cell mt-10">
                        <text class="font-12 color-gray">{{ $t('contract.tt4') }}</text>
                        <text class="font-12 color-black">
                        ...
                        <template v-if="mindex===tab.id">
                            ...
                            <view class="drawer-list-cell"
                                ...
                                <view class="drawer-list-cell-item">
                                    <text class="font-14 color-black font-weight">
                                        {{ item['symbol'] }}/{{ tab.legal ? tab.legal.symbol : '' }}
                                    </text>
                                </view>
                                <view class="drawer-list-cell-item">
                                    <text

<template>
	<view :class="[styleType === 'text'?'segmented-control--text' : 'segmented-control--button' ]"
		...
		index === 0&&styleType === 'button' ? 'segmented-control__item--button--first': '',
			...
			:style="{'margin-right':styleType==='text' ?'10px':'','justify-content':styleType==='text' ?'left':'center', backgroundColor: index === currentIndex && styleType === 'button' ? activeColor : '',borderColor: index === currentIndex&&styleType === 'text'||styleType === 'button'?activeColor:'transparent' }"
